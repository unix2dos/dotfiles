...
SOURCE_SCRIPT="$ROOT_DIR/agent-skills/sources.sh"
INSTALL_SCRIPT="$ROOT_DIR/agent-skills/install.sh"
README_SCRIPT="$ROOT_DIR/agent-skills/README.md"
...
run_docs_test() {
  ...
  assert_file_contains "$ROOT_README" "agent-skills/README.md"
}
